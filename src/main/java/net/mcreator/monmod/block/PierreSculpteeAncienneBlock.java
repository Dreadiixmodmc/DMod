...
public class PierreSculpteeAncienneBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:pierre_sculptee_ancienne")
	public static final Block block = null;

	public PierreSculpteeAncienneBlock(MonModModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pierre_sculptee_ancienne");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PierreSculpteeAncienneBlock.block));
		}
	}
}
