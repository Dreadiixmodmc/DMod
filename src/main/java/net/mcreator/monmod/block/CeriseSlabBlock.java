...
public class CeriseSlabBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:cerise_slab")
	public static final Block block = null;

	public CeriseSlabBlock(MonModModElements instance) {
		super(instance, 116);
	}
