...
public class EscalierenRocheAncienneBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:escalieren_roche_ancienne")
	public static final Block block = null;

	public EscalierenRocheAncienneBlock(MonModModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("escalieren_roche_ancienne");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EscalierenRocheAncienneBlock.block));
		}
	}
}
