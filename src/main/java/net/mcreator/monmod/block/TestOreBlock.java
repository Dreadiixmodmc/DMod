...
import net.mcreator.monmod.item.TestItem;
...
public class TestOreBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:test_ore")
	public static final Block block = null;

	public TestOreBlock(MonModModElements instance) {
		super(instance, 314);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TestItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("mon_mod:test_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("test_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mon_mod:test_ore"), configuredFeature);
		}
	}
