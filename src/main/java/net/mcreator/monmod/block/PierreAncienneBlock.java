...
public class PierreAncienneBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:pierre_ancienne")
	public static final Block block = null;

	public PierreAncienneBlock(MonModModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pierre_ancienne");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PierreAncienneBlock.block));
		}
	}
}
