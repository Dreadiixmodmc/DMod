...
public class MuretenPierreAncienneMoussuesBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:mureten_pierre_ancienne_moussues")
	public static final Block block = null;

	public MuretenPierreAncienneMoussuesBlock(MonModModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mureten_pierre_ancienne_moussues");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MuretenPierreAncienneMoussuesBlock.block));
		}
	}
}
