...
public class CeriseStairsBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:cerise_stairs")
	public static final Block block = null;

	public CeriseStairsBlock(MonModModElements instance) {
		super(instance, 115);
	}
