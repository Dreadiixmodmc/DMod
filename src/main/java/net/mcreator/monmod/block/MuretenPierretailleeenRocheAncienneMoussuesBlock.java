...
public class MuretenPierretailleeenRocheAncienneMoussuesBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:mureten_pierretailleeen_roche_ancienne_moussues")
	public static final Block block = null;

	public MuretenPierretailleeenRocheAncienneMoussuesBlock(MonModModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mureten_pierretailleeen_roche_ancienne_moussues");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MuretenPierretailleeenRocheAncienneMoussuesBlock.block));
		}
	}
}
