...
public class PierretailleeenRocheAncienneBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:pierretailleeen_roche_ancienne")
	public static final Block block = null;

	public PierretailleeenRocheAncienneBlock(MonModModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pierretailleeen_roche_ancienne");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PierretailleeenRocheAncienneBlock.block));
		}
	}
}
