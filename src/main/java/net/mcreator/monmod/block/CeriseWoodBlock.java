...
public class CeriseWoodBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:cerise_wood")
	public static final Block block = null;

	public CeriseWoodBlock(MonModModElements instance) {
		super(instance, 111);
	}
