...
public class CeriseFenceBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:cerise_fence")
	public static final Block block = null;

	public CeriseFenceBlock(MonModModElements instance) {
		super(instance, 117);
	}
