...
public class DalleenRocheAncienneBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:dalleen_roche_ancienne")
	public static final Block block = null;

	public DalleenRocheAncienneBlock(MonModModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dalleen_roche_ancienne");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DalleenRocheAncienneBlock.block));
		}
	}
}
