...
public class CeriseLogBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:cerise_log")
	public static final Block block = null;

	public CeriseLogBlock(MonModModElements instance) {
		super(instance, 112);
	}
