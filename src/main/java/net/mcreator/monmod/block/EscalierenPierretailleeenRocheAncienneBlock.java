...
public class EscalierenPierretailleeenRocheAncienneBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:escalieren_pierretailleeen_roche_ancienne")
	public static final Block block = null;

	public EscalierenPierretailleeenRocheAncienneBlock(MonModModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("escalieren_pierretailleeen_roche_ancienne");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EscalierenPierretailleeenRocheAncienneBlock.block));
		}
	}
}
