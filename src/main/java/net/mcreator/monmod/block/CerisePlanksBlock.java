...
public class CerisePlanksBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:cerise_planks")
	public static final Block block = null;

	public CerisePlanksBlock(MonModModElements instance) {
		super(instance, 113);
	}
