...
public class PierreTailleeCraqueleeAncienneBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:pierre_taillee_craquelee_ancienne")
	public static final Block block = null;

	public PierreTailleeCraqueleeAncienneBlock(MonModModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pierre_taillee_craquelee_ancienne");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PierreTailleeCraqueleeAncienneBlock.block));
		}
	}
}
