...
public class MuretenPierreAncienneBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:mureten_pierre_ancienne")
	public static final Block block = null;

	public MuretenPierreAncienneBlock(MonModModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mureten_pierre_ancienne");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MuretenPierreAncienneBlock.block));
		}
	}
}
