...
public class DalleenPierreAncienneBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:dalleen_pierre_ancienne")
	public static final Block block = null;

	public DalleenPierreAncienneBlock(MonModModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dalleen_pierre_ancienne");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DalleenPierreAncienneBlock.block));
		}
	}
}
