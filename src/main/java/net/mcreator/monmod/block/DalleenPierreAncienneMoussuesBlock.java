...
public class DalleenPierreAncienneMoussuesBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:dalleen_pierre_ancienne_moussues")
	public static final Block block = null;

	public DalleenPierreAncienneMoussuesBlock(MonModModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dalleen_pierre_ancienne_moussues");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DalleenPierreAncienneMoussuesBlock.block));
		}
	}
}
