...
public class MuretenPierretailleeenRocheAncienneBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:mureten_pierretailleeen_roche_ancienne")
	public static final Block block = null;

	public MuretenPierretailleeenRocheAncienneBlock(MonModModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mureten_pierretailleeen_roche_ancienne");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MuretenPierretailleeenRocheAncienneBlock.block));
		}
	}
}
