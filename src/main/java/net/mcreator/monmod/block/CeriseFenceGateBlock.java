...
public class CeriseFenceGateBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:cerise_fence_gate")
	public static final Block block = null;

	public CeriseFenceGateBlock(MonModModElements instance) {
		super(instance, 118);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("cerise_fence_gate");
		}
