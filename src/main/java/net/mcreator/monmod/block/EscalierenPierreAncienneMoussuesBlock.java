...
public class EscalierenPierreAncienneMoussuesBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:escalieren_pierre_ancienne_moussues")
	public static final Block block = null;

	public EscalierenPierreAncienneMoussuesBlock(MonModModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("escalieren_pierre_ancienne_moussues");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EscalierenPierreAncienneMoussuesBlock.block));
		}
	}
}
