...
public class PierretailleeenRocheAncienneMoussuesBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:pierretailleeen_roche_ancienne_moussues")
	public static final Block block = null;

	public PierretailleeenRocheAncienneMoussuesBlock(MonModModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pierretailleeen_roche_ancienne_moussues");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PierretailleeenRocheAncienneMoussuesBlock.block));
		}
	}
}
