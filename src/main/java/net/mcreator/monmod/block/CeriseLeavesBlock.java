...
public class CeriseLeavesBlock extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:cerise_leaves")
	public static final Block block = null;

	public CeriseLeavesBlock(MonModModElements instance) {
		super(instance, 273);
	}
