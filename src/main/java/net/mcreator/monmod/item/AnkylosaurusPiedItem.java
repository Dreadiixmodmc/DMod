...
public class AnkylosaurusPiedItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:ankylosaurus_pied")
	public static final Item block = null;

	public AnkylosaurusPiedItem(MonModModElements instance) {
		super(instance, 245);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ankylosaurus_pied");
		}
