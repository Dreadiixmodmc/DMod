...
public class AnkylosauruscagethoraciqueItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:ankylosauruscagethoracique")
	public static final Item block = null;

	public AnkylosauruscagethoraciqueItem(MonModModElements instance) {
		super(instance, 246);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ankylosauruscagethoracique");
		}
