...
public class AnkylosaurusBrasItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:ankylosaurus_bras")
	public static final Item block = null;

	public AnkylosaurusBrasItem(MonModModElements instance) {
		super(instance, 244);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ankylosaurus_bras");
		}
