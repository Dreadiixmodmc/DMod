...
public class AllosaurusCraneItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:allosaurus_crane")
	public static final Item block = null;

	public AllosaurusCraneItem(MonModModElements instance) {
		super(instance, 231);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("allosaurus_crane");
		}
