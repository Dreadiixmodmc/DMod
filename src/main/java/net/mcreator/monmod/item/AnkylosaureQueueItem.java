...
public class AnkylosaureQueueItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:ankylosaure_queue")
	public static final Item block = null;

	public AnkylosaureQueueItem(MonModModElements instance) {
		super(instance, 248);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ankylosaure_queue");
		}
