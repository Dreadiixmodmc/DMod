...
public class AllosaurusBrasItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:allosaurus_bras")
	public static final Item block = null;

	public AllosaurusBrasItem(MonModModElements instance) {
		super(instance, 234);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("allosaurus_bras");
		}
