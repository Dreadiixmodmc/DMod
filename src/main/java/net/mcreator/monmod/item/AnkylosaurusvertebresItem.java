...
public class AnkylosaurusvertebresItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:ankylosaurusvertebres")
	public static final Item block = null;

	public AnkylosaurusvertebresItem(MonModModElements instance) {
		super(instance, 247);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ankylosaurusvertebres");
		}
