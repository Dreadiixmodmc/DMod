...
public class AllosaurusGriffeItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:allosaurus_griffe")
	public static final Item block = null;

	public AllosaurusGriffeItem(MonModModElements instance) {
		super(instance, 238);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("allosaurus_griffe");
		}
