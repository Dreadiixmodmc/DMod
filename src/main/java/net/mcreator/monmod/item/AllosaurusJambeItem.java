...
public class AllosaurusJambeItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:allosaurus_jambe")
	public static final Item block = null;

	public AllosaurusJambeItem(MonModModElements instance) {
		super(instance, 233);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("allosaurus_jambe");
		}
