...
public class AllosaurusVertebresItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:allosaurus_vertebres")
	public static final Item block = null;

	public AllosaurusVertebresItem(MonModModElements instance) {
		super(instance, 237);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("allosaurus_vertebres");
		}
