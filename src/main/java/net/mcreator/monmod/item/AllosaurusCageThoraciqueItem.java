...
public class AllosaurusCageThoraciqueItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:allosaurus_cage_thoracique")
	public static final Item block = null;

	public AllosaurusCageThoraciqueItem(MonModModElements instance) {
		super(instance, 236);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("allosaurus_cage_thoracique");
		}
