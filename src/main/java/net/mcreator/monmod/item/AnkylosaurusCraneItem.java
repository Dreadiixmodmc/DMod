...
public class AnkylosaurusCraneItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:ankylosaurus_crane")
	public static final Item block = null;

	public AnkylosaurusCraneItem(MonModModElements instance) {
		super(instance, 242);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ankylosaurus_crane");
		}
