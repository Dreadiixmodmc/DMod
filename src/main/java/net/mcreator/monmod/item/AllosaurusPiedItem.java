...
public class AllosaurusPiedItem extends MonModModElements.ModElement {
	@ObjectHolder("mon_mod:allosaurus_pied")
	public static final Item block = null;

	public AllosaurusPiedItem(MonModModElements instance) {
		super(instance, 235);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("allosaurus_pied");
		}
